...
public class UserUtils {
    ...
    public static final String ROOMID="113344";
    public static final String APP_KEY = "z3v5yqkbv8v30";
    public static final String USER_TOKEN_1="KI8S4NeAndh8ceXyc0+vxX2fyU87Zn6ZVguvQ1awzCHrWCPJVWiMLQ==@emx6.cn.rongnav.com;emx6.cn.rongcfg.com";
    public static final String USER_NAME_1="USER_A";

//    public static final String ROOMID = 房间号码;
//    public static final String APP_KEY = APPKEY;
//    public static final String USER_TOKEN_1 = 用户TOKEN;
//    public static final String USER_NAME_1 = “用户TOKEN” 的用户名，可随意指定，但是不能为空;
